...
stockQueryRequest = "http://www.alphavantage.co/query?function=TIME_SERIES_INTRADAY&symbol=%s&interval=1min&outputsize=compact&apikey=demo"
...
while var == 1 :  # This constructs an infinite loop
	...
	fileName = "stocks_price_"+str(time.time())+".json"
